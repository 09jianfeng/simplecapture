...
#define FFMPEG_CONFIGURATION "--cc=/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang --arch=x86_64 --cpu=x86_64 --sysroot=/Applications/Xcode.app/Contents/Developer/Platforms/iPhoneSimulator.platform/Developer/SDKs/iPhoneSimulator10.3.sdk --target-os=darwin --prefix=./build/buildgene/ios/intermediate/x86_64 --extra-cflags='-arch x86_64 -mios-simulator-version-min=6.0 -I/Users/jimmychen/Documents/ffmpeg-3.3.2.170717/x264/build/buildgene/thin-x264/x86_64/include' --extra-ldflags='-arch x86_64 -mios-simulator-version-min=6.0 -L/Users/jimmychen/Documents/ffmpeg-3.3.2.170717/x264/build/buildgene/thin-x264/x86_64/lib' --enable-cross-compile --enable-pic --as='/Users/jimmychen/Documents/ffmpeg-3.3.2.170717/build/ios/gas-preprocessor.pl /Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang' --disable-everything --disable-iconv --enable-decoder=aac --enable-decoder=h264 --enable-decoder=hevc --enable-asm --enable-thumb --enable-demuxer=mpegts --enable-demuxer=mpegvideo --enable-muxer=mp4 --enable-demuxer=avi --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=matroska --enable-demuxer=mov --enable-demuxer=rm --enable-network --enable-demuxer=flv --enable-muxer=flv --enable-protocol=file --enable-protocol=tcp --enable-protocol=rtmp --enable-demuxer=rtsp --enable-parser=aac --enable-zlib --enable-gpl --enable-nonfree --enable-version3 --enable-encoder=libx264 --enable-libx264 --enable-decoder='aac,mpeg4' --enable-encoder='aac,mpeg4' --enable-encoder=pcm_s16le --enable-decoder=pcm_s16le --enable-demuxer='mp3,wav' --enable-muxer='mp3,wav' --enable-demuxer='apng,png,zlib' --enable-decoder=mp3 --enable-muxer=image2 --enable-demuxer=image2 --enable-demuxer=mjpeg --enable-decoder='png,mjpeg,bmp,zlib' --enable-encoder='png,mjpeg,bmp' --enable-avfilter --enable-filters --enable-avutil --enable-thumb --enable-demuxer=concat --enable-bsfs --enable-hwaccels --enable-avresample --disable-filter=ycloudphotoblend"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2017
#define FFMPEG_DATADIR "./build/buildgene/ios/intermediate/x86_64/share/ffmpeg"
#define AVCONV_DATADIR "./build/buildgene/ios/intermediate/x86_64/share/ffmpeg"
...
#define CONFIG_GPUBEAUTY_FILTER 1
