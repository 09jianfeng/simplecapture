...
#define X264_ME_CET2                 1
#define X264_ME_NS                   2
#define X264_ME_HEX                  3
#define X264_ME_UMH                  4
#define X264_ME_ESA                  5
#define X264_ME_TESA                 6

//CET2 and NS, edited by yihao
...
static const char * const x264_motion_est_names_2[] = { "dia","cet2","ns","hex", "umh", "esa", "tesa", 0 };
...
typedef struct x264_param_t
{
    ...
    struct
    {
        ...
        int          b_fast_slicetype;
        int          i_slicetype_me_refine;
        int          b_fast_slicetype_intra;
        
        int          b_force_fast_skip_p;/* force using x264_macroblock_probe_pskip to detect SKIP mode */
		int          b_force_fast_skip_b;/* force using x264_macroblock_probe_pskip to detect SKIP mode */
        int          b_fast_qpel;
        int          b_fast_hpel;/*try half pel for mode checking process, defaut 1 for veryfast preset*/
        int          i_try_hpel_threshold;/*threshhold for b_fast_hpel, larger->faster, default 2000*/
        int          i_hdp_th_percentage;
        int          b_fast_mode_decision_hdp;
        int          b_transform_8x8;
...
/*Export function. By Chenjinkai*/
/* x264_param2string: return a (malloced) string containing most of
 * the encoding options */
char *x264_param2string( x264_param_t *p, int b_res );
/* x264_free: free the memory that alloc by  x264_param2string */
void  x264_free( void * );
#ifdef __cplusplus
}
#endif
