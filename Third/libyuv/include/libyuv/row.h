...
//#define HAS_YUVATOUV12ROW_NEON
#define HAS_UYVYTOYROW_NEON
#if defined(__aarch64__)
#define HAS_YUVATOYROW_NEON
#endif
...
void YUVAToYRow_C(const uint8* src_yuva, uint8* dst_y, int width);
void YUVAToUV12Row_C(const uint8* src_yuva, int src_stride_yuva, uint8* dst_uv, int width);
void YUVAToUV420Row_C(const uint8* src_yuva, int src_stride_yuva, uint8* dst_u, uint8* dst_v, int width);

void YUVAToYRow_Any_NEON(const uint8* src_yuva, uint8* dst_y, int width);
void YUVAToUV12Row_Any_NEON(const uint8* src_yuva, int src_stride_yuva, uint8* dst_uv, int width);
void YUVAToUV420Row_Any_NEON(const uint8* src_yuva, int src_stride_yuva, uint8* dst_u, uint8* dst_v, int width);

void YUVAToYRow_NEON(const uint8* src_yuva, uint8* dst_y, int width);
void YUVAToUV12Row_NEON(const uint8* src_yuva, int src_stride_yuva, uint8* dst_uv, int width);
void YUVAToUV420Row_NEON(const uint8* src_yuva, int src_stride_yuva, uint8* dst_u, uint8* dst_v, int width);
...
void ARGBToBayerGGRow_Any_NEON(const uint8* src_argb, uint8* dst_bayer,
                               uint32 /* selector */, int pix);
void TestZipUzp(const uint8* src, uint8* dst, int pix);
