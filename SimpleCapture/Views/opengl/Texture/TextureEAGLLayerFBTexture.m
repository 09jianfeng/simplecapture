...
@implementation TextureEAGLLayerFBTexture{
    ...
    GLuint _colorIndex;
    GLuint _screenTextureIndex;
    GLuint _screenPositionIndex;
    GLuint _screenColorIndex;
...
- (void)buildProgram{
    ...
    _screenPositionIndex = [_screenProgram attributeIndex:@"aPos"];
    _screenTextureIndex = [_screenProgram attributeIndex:@"aTextCoord"];
    _screenColorIndex = [_screenProgram attributeIndex:@"acolor"];
}
